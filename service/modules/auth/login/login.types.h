...
RUVIA_RESPONSE_MODEL(AuthUserInfoDto, RUVIA_OPTIONAL_FIELD(id, ruvia::Int64),
                     ...
                     RUVIA_OPTIONAL_FIELD(menus, ruvia::BoxedArray<menu::MenuDto>));

RUVIA_RESPONSE_MODEL(LoginResultDto, RUVIA_OPTIONAL_FIELD(token, ruvia::String),
                     RUVIA_OPTIONAL_FIELD_NAME("refresh_token", refreshToken, ruvia::String),
                     RUVIA_OPTIONAL_FIELD(user, AuthUserInfoDto));

RUVIA_RESPONSE_MODEL(LoginResponse, RUVIA_OPTIONAL_FIELD(code, ruvia::Int64),
                     RUVIA_OPTIONAL_FIELD(message, ruvia::String),
                     RUVIA_OPTIONAL_FIELD(data, LoginResultDto));

RUVIA_RESPONSE_MODEL(CurrentUserResponse, RUVIA_OPTIONAL_FIELD(code, ruvia::Int64),
                     RUVIA_OPTIONAL_FIELD(message, ruvia::String),
