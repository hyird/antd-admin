...
RUVIA_REQUEST_MODEL(LoginBody, RUVIA_FIELD(username, ruvia::String), RUVIA_FIELD(password, ruvia::String));

RUVIA_REQUEST_MODEL(RefreshBody, RUVIA_FIELD_NAME("refresh_token", refreshToken, ruvia::String));

RUVIA_RESPONSE_MODEL(AuthUserInfoDto, RUVIA_FIELD(id, ruvia::Int64), RUVIA_FIELD(username, ruvia::String),
...
RUVIA_RESPONSE_MODEL(LoginResponse, RUVIA_FIELD(code, ruvia::Int64), RUVIA_FIELD(message, ruvia::String),
           RUVIA_FIELD(data, LoginResultDto));

RUVIA_RESPONSE_MODEL(CurrentUserResponse, RUVIA_FIELD(code, ruvia::Int64), RUVIA_FIELD(message, ruvia::String),
