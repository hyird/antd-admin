...
import { roleRoute } from '@/modules/system/role/role.route';
import { menuRoute } from '@/modules/system/menu/menu.route';
import { userRoute } from '@/modules/system/user/user.route';
import { departmentRoute } from '@/modules/system/department/department.route';
