...
const ACCOUNT_STATS = [
    ...
    },
    {
        key: 'menuCount',
        title: '可见菜单',
        getValue: (user: ReturnType<typeof useCurrentUser>['data']) => user?.menus?.length ?? 0,
        suffix: '项',
    },
] as const;
            ...
            >
                ...
                <Card title="快捷操作">
                    ...
                    <Row gutter={[12, 12]}>
                        ...
                        <Col xs={24} sm={12} md={8}>
                            <Text type="secondary">角色权限</Text>
                        </Col>
                        <Col xs={24} sm={12} md={8}>
                            <Text type="secondary">菜单配置</Text>
                        </Col>
                        <Col xs={24} sm={12} md={8}>
                            <Text type="secondary">部门组织</Text>
                        </Col>
                    </Row>
                </Card>
